    ...
    def terminate(self, new_status):
        ...
        if not self._terminated:
            if self.test_status == "FAILURE":
                ...
                traffic_event.set_message("Agent failed to yield to an emergency vehicle at t={}s".format(
                        round(GameTime.get_time(), 3)))
...
class ScenarioTimeoutTest(Criterion):
    ...
    def terminate(self, new_status):
        ...
        if timeout:
            ...
            traffic_event.set_message("Agent timed out a scenario at t={}s".format(
                        round(GameTime.get_time(), 3)))
            self.events.append(traffic_event)
