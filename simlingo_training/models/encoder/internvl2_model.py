...
class LingoInternVLModel(nn.Module):
    ...
    def replace_placeholder_tokens(
        ...
        if inputs_embeds is None:
            ...
            if special_ids.size(0) > 0 and placeholder_values and len(placeholder_values) > 0:
                ...
                first_occurrences = torch.argmax(first_occurrence_mask.float(), dim=2).transpose(0, 1)
            ...
            if pixel_values is not None and input_ids.shape[1] != 1 and pixel_values.size(0) > 0:
                ...
                pixel_values_tmp = pixel_values.view(BS, NP, C, H, W)
                ...
                image_features = self.model.extract_feature(pixel_values_tmp).reshape(-1, C_embed)
                ...
                try:
                    ...
                    print(f'warning: {e}, inputs_embeds[selected].shape={inputs_embeds[selected].shape}, vit_embeds.shape={vit_embeds.shape}')
